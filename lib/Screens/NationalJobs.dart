...
class NationalDetail extends StatelessWidget {
  ...
  final NationalJob job;

  NationalDetail({required this.job});
  ...
  List<Widget> buildRequirements(){
    List<Widget> list = [];
    for (var i = 0; i < getNationalJobsRequirements().length; i++) {
      list.add(buildRequirement(getNationalJobsRequirements()[i]));
    }
    return list;
  }
